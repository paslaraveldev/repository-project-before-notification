...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#projects-nav" data-bs-toggle="collapse" href="#">
          <i class=""></i><span>Projects</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="projects-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-third-year.html">
              <i class="bi bi-circle"></i><span>Third Year</span>
            </a>
          </li>
          <li>
            <a href="components-fourth-year.html">
              <i class="bi bi-circle"></i><span>Fourth Year</span>
            </a>
          </li>
          <li>
            <a href="components-postgraduate.html">
              <i class="bi bi-circle"></i><span>Postgraduate</span>
            </a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#research-nav" data-bs-toggle="collapse" href="#">
          <i class=""></i><span>Research Management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="research-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="research-submissions.html">
              <i class="bi bi-circle"></i><span>Submissions</span>
            </a>
          </li>
          <li>
            <a href="research-review.html">
              <i class="bi bi-circle"></i><span>Review Process</span>
            </a>
          </li>
          <li>
            <a href="research-archives.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#roles-nav" data-bs-toggle="collapse" href="#">
          <i class=""></i><span>Roles & Permissions</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#publications-nav" data-bs-toggle="collapse" href="#">
          <i class=""></i><span>Publications</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="publications-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="publications-accepted.html">
              <i class="bi bi-circle"></i><span>Accepted</span>
            </a>
          </li>
          <li>
            <a href="publications-rejected.html">
              <i class="bi bi-circle"></i><span>Rejected</span>
            </a>
          </li>
          <li>
            <a href="publications-draft.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#analytics-nav" data-bs-toggle="collapse" href="#">
          <i class=""></i><span>Analytics</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="analytics-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="analytics-overview.html">
              <i class="bi bi-circle"></i><span>Overview</span>
            </a>
          </li>
          <li>
            <a href="analytics-usage.html">
              <i class="bi bi-circle"></i><span>Usage</span>
            </a>
          </li>
          <li>
            <a href="analytics-statistics.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#admin-nav" data-bs-toggle="collapse" href="#">
          <i class=""></i><span>System Administration</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="admin-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="system-backups.html">
              <i class="bi bi-circle"></i><span>Backups</span>
            </a>
          </li>
          <li>
            <a href="system-logs.html">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>grpou 12</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">pascal</a>
    </div>
  </footer><!-- End Footer -->
